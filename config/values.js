...
const values = {
  ...
  welcomeMessage: EnvVars.string('WELCOME_MSG', 'Tarteel.io'),
  ...
  htmlPage: {
    titleTemplate: 'Tarteel.io - %s',
    defaultTitle: 'Tarteel.io',
    description:
      "The world's first crowdsourced database of Quran recitations for machine learning applications.",
  },
  ...
  bundles: {
    ...
    server: {
      // Src entry file.
      srcEntryFile: './src/server/index.ts',
